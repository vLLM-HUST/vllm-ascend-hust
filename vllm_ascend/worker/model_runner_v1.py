    ...
    def initialize_kv_cache_tensors(
        ...
        with allocation_context:
            if kv_cache_config.kv_cache_tensors and hasattr(
                ...
                # layer/block strides and offsets remain authoritative.
                kernel_block_sizes = [
                ...
                native_planes = any(
                    ...
                    and getattr(spec, "num_head_slots", None) == 2
                ...
                if (
                    ...
                    from vllm_ascend.worker.hybrid_cache import (
                        allocate_native_hybrid_cache,
                    )
