...
def load_upstream_metadata() -> dict[str, str]:
    ...
    if missing_fields:
        ...
        raise RuntimeError(f"Missing required fields in {UPSTREAM_METADATA_FILE}: {missing_list}")
